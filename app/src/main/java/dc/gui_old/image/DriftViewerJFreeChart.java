...
public class DriftViewerJFreeChart extends JPanel {
	private static final Logger logger = Logger.getLogger(DriftViewerJFreeChart.class.getName());
	private XYSeries rawDrift;
	private XYSeries fittedDrift;
	private Synchroniser mySynchroniser;
	
	private int[] idxList;
	public DriftViewerJFreeChart() {
...
//				System.out.println(item);
    ...
    private static void createAndShowGUI() {
        ...
        DriftViewerJFreeChart imageViewer = new DriftViewerJFreeChart();
