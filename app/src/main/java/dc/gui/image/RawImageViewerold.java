...
public class RawImageViewerold extends JPanel implements ChangeListener {
	private static final Logger logger = Logger.getLogger(RawImageViewerold.class.getName());
...
//    BufferedImage image;
	...
	public RawImageViewerold(Synchroniser sync) {
		this.sync = sync;
