...
public class SettingPanel  extends JPanel {
	...
	public SettingPanel(Controller controller) {
		logger.setLevel(Level.FINE);
		this.controller = controller;
		
		ioPanel = new IOPanel(controller);
		templateMatchingPanel = new TemplateMatchingPanel(controller);
		driftEditingPanel = new DriftEditingPanel(controller);
		driftCorrectionPanel = new DriftCorrectionPanel(controller);
